...
export default function ContactSection({ heading = "h2" }) {
  ...
  return (
    <div id="contact" className="od-band od-section-pad od-stack" style={{ ...odBand, height: 908, background: "var(--od-navy)", display: "flex", gap: 120, padding: "120px 80px", alignItems: "center" }}>
