...
export default function ReviewsSection({ google }) {
  ...
  return (
    <div className="od-band od-section-pad" style={{ ...odBand, background: "var(--od-off-white)", display: "flex", flexDirection: "column", gap: 40, padding: 80, alignItems: "center" }}>
      <h2 className="od-h2" style={odH2}>Client Reviews</h2>
      <div className="od-reviews" style={{ minHeight: 237, display: "flex", gap: 32, alignSelf: "stretch", flexShrink: 0, alignItems: "stretch" }}>
        {shown.map(([q, n, l, r], i) => (
