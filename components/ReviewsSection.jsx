...
export default function ReviewsSection({ google }) {
  ...
  return (
    <div className="od-band od-section-pad" style={{ ...odBand, background: "var(--od-off-white)", padding: "48px 0", boxSizing: "border-box" }}>
      <div className="od-reviews-w1280" style={{ width: 1280, maxWidth: "100%", margin: "0 auto", padding: "0 48px", boxSizing: "border-box", display: "flex", flexDirection: "column", gap: 40, alignItems: "center" }}>
