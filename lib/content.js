...
export const HOME_BENEFITS = [
  ...
  ["12+ years of experience in London", "Free on-site visit before every quote"],
];

export const SERVICES = [
  ["handyman", "Handyman Services", "General repairs, fittings and small jobs handled quickly and properly, whatever the task."],
  ["kitchen", "Kitchen Remodelling", "Full kitchen renovations from design through to fitting, tiling and finishing touches."],
  ["bathroom", "Bathroom Remodelling", "Complete bathroom renovations covering tiling, plumbing and fixtures, done to a high standard."],
  ["flooring", "Flooring", "Professional flooring installation across every room, finish and material."],
  ["carpentry", "Carpentry", "Custom woodwork, fitted storage and bespoke joinery built to fit your home."],
  ["home-decor", "Home Decor", "Painting, decorating and styling touches that bring a finished space together."],
];
...
// 13 named areas, the same list the contact page's Service Areas section
// uses, split into pairs for the two-tag-per-row layout of "locations-row-1".
export const AREAS_HOME = ["Battersea", "Central London", "Chelsea", "Clapham Common", "Clapham Junction", "Clapham North", "Clapham South", "Kennington", "Oval", "Pimlico", "Stockwell", "Vauxhall", "Victoria"];
export const AREA_ROWS_HOME = Array.from({ length: Math.ceil(AREAS_HOME.length / 2) }, (_, i) => AREAS_HOME.slice(i * 2, i * 2 + 2));
export const AREA_HALVES_HOME = [AREAS_HOME.slice(0, 7), AREAS_HOME.slice(7, 13)];
